...
export const projects = [
  ...
  },
  {
    ...
    description: [
      'A real-time environment I built end to end to work the full art pipeline: modeling in Maya, texturing in Substance Painter, then assembling, lighting, and rendering the scene in Unreal Engine.',
  ...
  },
  {
    ...
    description: [
      'A programming-focused project I built to push real-time systems rather than art.',
