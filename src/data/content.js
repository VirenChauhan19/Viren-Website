...
// type: 'ai' | 'game' — drives the accent color and 3D shape per project.
export const projects = [
  ...
  },
  {
    ...
    media: [
      { type: 'video', src: 'top-down-shooter.mp4', caption: 'Gameplay capture' },
      { type: 'image', src: 'top-down-shooter-shot.jpg', caption: 'In-game screenshot' },
    ],
    live: null,
    repo: null,
  },
